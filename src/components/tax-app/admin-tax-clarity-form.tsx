...
export function AdminTaxClarityForm() {
  ...
  const handleAdminDownload = () => {
    if (!results) {
        toast({
            variant: "destructive",
            title: "Calculation needed",
            description: "Please calculate the tax before getting a report.",
        });
        return;
    }
    ...
    try {
        ...
        toast({
            ...
            description: "There was an error preparing your report data.",
        });
    }
  };
              ...
              {showReportCTA && (
                <div className="!mt-20 md:!mt-24 text-center">
                  ...
                  <h3 className="mt-4 text-2xl md:text-3xl font-semibold text-foreground tracking-tight">
                    Get your detailed personal report — Free
                  </h3>
